    ...
    <section className="bg-white py-16">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center lg:text-left">
        ...
        <h2 className="mt-4 text-3xl lg:text-4xl font-bold text-gray-900">
          Trusted by passengers across France
        </h2>
        <p className="mt-4 text-gray-700 max-w-2xl">
          At <strong>France Buses</strong>, we take pride in delivering safe, reliable, and comfortable travel
        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-blue-600 text-white p-10 rounded-2xl shadow-lg">
            ...
            <p className="mt-4 text-lg opacity-90">
              Every year, more than a quarter of a million passengers travel with France Buses for dependable,
              comfortable journeys throughout France — including Paris, Lyon, Marseille, and Bordeaux.
            </p>
          </div>
